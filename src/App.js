    ...
    <div className="App">
      ...
      <Navbar />
        <div className={styles.myTextContainer}>
          <h1 className={styles.myTitle}>Software Developer</h1>
          <p className={`${styles.myIntro}`}>Determined to deliver seamless products</p>
          ...
          <a href="#contact"><button className="btn btn-outline-light fs-3 m-3">My Information</button></a>
            <p className={styles.myStack}>
                <span><img src={jsIcon} alt="" className={styles.stackLogo}/></span>
