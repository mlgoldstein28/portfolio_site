...
export default function About() {
    ...
    return (
        <div id="contact" className={`${styles.container} pb-3`}>
            ...
            <div className="text-center fw-bold">
                ...
                <div className="fw-bold text-primary">
                    <FontAwesomeIcon icon={faEnvelope}/><a href="mailto:mlgoldstein28@gmail.com">MLGoldstein28@gmail</a><span className="m-3"></span>
                    <FontAwesomeIcon icon={faFile} className="me-1"/><a href={resume}>Resume</a><span className="m-3"></span>
                    <FontAwesomeIcon icon={faPhone} className="me-1"/><a href="tel:2018033947">(201) 803-3947</a>
                </div>     
            </div>
            <form className="w-100 border border-light m-auto">
